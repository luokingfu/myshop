/*删除商城数据库,如果存在*/
drop database if exists sq_java0604;
/*创建数据库,并设置编码*/
create database sq_java0604 default character set utf8;
...
/* 修改自动增长的初始值 */
ALTER TABLE forder AUTO_INCREMENT = 2000021301;
...
INSERT INTO user (login,pass,sex,phone,email) VALUES ('user01','user01','男','13724044380','soft03_test@sina.com');
/*插入购物车测试用例*/
